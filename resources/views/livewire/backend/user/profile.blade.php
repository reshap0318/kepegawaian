...
<div class="mt-4 mb-4 max-w-3xl mx-auto grid grid-cols-1 gap-6 sm:px-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
    <div class="space-y-6 lg:col-start-1 lg:col-span-3">
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <dl class="grid grid-cols-2 gap-x-4 gap-y-8 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->username ?? "Belum Disetting" }}
                            </dd>
                        </div>
                    </dl>
                </div>
                ...
                <div class="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <dl class="grid grid-cols-3 gap-x-4 gap-y-8">
                        <div class="sm:col-span-1">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->nama_lengkap ?? "Belum Disetting" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->nip ?? "Belum Disetting" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->no_hp ?? "000 000 0000" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->jenis_kelamin_text }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->tempat_lahir. ", ".Auth::user()->pegawai->tgl_lahir }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->nidn ?? "Belun Disetting" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->npwp ?? "Belun Disetting" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->tipe ?? "Belun Disetting" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->ikatan_kerja ? "Ya" : "Tidak" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->tgl_pensiun ?? "Belun Disetting" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-1">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->status ?? "Belun Disetting" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-3">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                {{ Auth::user()->pegawai->alamat ?? "Belun Disetting" }}
                            </dd>
                        </div>
                        <div class="sm:col-span-3">
                            <dt class="text-sm font-medium text-gray-500">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">
                                ...
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                                    ...
                                    <!-- Heroicon name: solid/paper-clip -->
                                        ...
                                        <span class="ml-2 flex-1 w-0 truncate">
                                            Surat_Kerja_Calon_Pegawai_Negeri_Sipil.pdf
                                        </span>
                                    </div> 
                                    <div class="ml-4 flex-shrink-0 flex items-start space-x-4">
                                        <a href="#" class="bg-white rounded-md font-medium text-purple-600 hover:text-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                                            Update
                                        </a>
                                        @if (Auth::user()->pegawai->file_sk_cpns)
                                ...
                                <li class="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                                    ...
                                    <!-- Heroicon name: solid/paper-clip -->
                                        ...
                                        <span class="ml-2 flex-1 w-0 truncate">
                                            Surat_Kerja_Pegawai_Negeri_Sipil.pdf
                                        </span>
                                    </div>
                                    <div class="ml-4 flex-shrink-0 flex items-start space-x-4">
                                        <a href="#" class="bg-white rounded-md font-medium text-purple-600 hover:text-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                                        ...
                                        @if (Auth::user()->pegawai->file_sk_pns)
                                          <span class="text-gray-300" aria-hidden="true">|</span>
                                          <a href="#" class="bg-white rounded-md font-medium text-purple-600 hover:text-purple-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                                            Remove
                                          </a>
        ...
        <section aria-labelledby="informasi Fungsional2">
            <livewire:backend.pegawai.fungsional.index :user="Auth::user()" :key="'user-fungsional-'.Auth::user()->id">
        </section>
    </div>    
</div>
