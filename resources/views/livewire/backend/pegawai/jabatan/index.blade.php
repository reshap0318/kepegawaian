<div class="mt-4">
    ...
    <div class="grid grid-cols-3 pb-3">
        ...
        <div class="text-right col-span-2">
            <x-form.button px="2" py="1" color="indigo" href="{{ route('pegawaiJabatans.create', $user) }}">
                    ...
                    <x-table.tr>
                        <td class="pl-6 py-4" style="width: 3px">
                            @if ($pegawaiJabatan->status)
                                <span class="h-5 w-5 rounded-full bg-green-500 flex items-center justify-center ring-5 ring-white" wire:click="changeStatus({{ $pegawaiJabatan }})">
                            ...
                            @else
                                <span class="h-5 w-5 rounded-full bg-gray-500 flex items-center justify-center ring-5 ring-white" wire:click="changeStatus({{ $pegawaiJabatan }})">
                                    <!-- Heroicon name: solid/check -->
                        ...
                        <x-table.td>
                            <x-form.button class="normal-case" px="3" py="1" color="indigo" href="{{ $pegawaiJabatan->file_sk_url }}" target="blank">
                            ...
                            <x-form.button class="normal-case" px="3" py="1" color="red" @click="show = true" wire:click="deleteModel({{ $pegawaiJabatan }})">
                                <svg class="h-3 w-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
