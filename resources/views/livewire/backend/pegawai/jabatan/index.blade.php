<div class="mt-4">
    ...
    <div class="grid grid-cols-3 pb-3">
        ...
        <div class="text-right col-span-2 flex space-x-1 justify-end">
            @can('pegawai-jabatan_manage')
            <x-table.button color="indigo" href="{{ route('pegawaiJabatans.create', $user) }}" class="px-3">
                ...
                @foreach ($pegawaiJabatans as $pegawaiJabatan)
                    <x-table.tr>
                        ...
                        <div class="flex space-x-1 justify-end">
                            ...
                            @can('pegawai-jabatan_manage')
                            <x-table.button color="indigo" @click="showConfirm = true"  wire:click="changeStatusModel({{ $pegawaiJabatan }})">
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </x-table.button>
                            <x-table.button href="{{ route('pegawaiJabatans.edit',['user' => $user, 'pegawaiJabatan' => $pegawaiJabatan]) }}">
                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
