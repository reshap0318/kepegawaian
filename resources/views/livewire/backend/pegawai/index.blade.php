<div class="mt-4">
    ...
    <x-slot name="header">
        <div class="inline-flex max-w-7xl mx-auto pt-2 px-4  sm:px-6 md:px-8">
            <h1 class="text-2xl font-semibold text-gray-900">Pegawai Unit</h1>
        </div>
    </x-slot>
    <div class="grid grid-cols-3 pb-3">
        ...
        @can('pegawai_manage')
            <div class="text-right col-span-2">
                <x-table.button class="inline-flex items-center px-4 py-1.5 text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 px-1.5" color="indigo" href="{{ route('pegawai.print') }}" target="_blank">
                                  ...
                                  <div class="flex space-x-1 justify-end">
                                    ...
                                    @can('pegawai_manage')
                                        ...
                                        @if(Auth()->user()->id != $pegawai->id)
                                            <x-table.button class="normal-case" color="red" @click="show = true" wire:click="cetak()">
                                                <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
