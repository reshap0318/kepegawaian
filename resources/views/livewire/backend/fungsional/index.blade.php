    ...
    <x-slot name="header">
        <div class="inline-flex max-w-7xl mx-auto pt-2 px-4  sm:px-6 md:px-8">
            ...
            @can('fungsionals_manage')    
                <div class="ml-2">
                    <x-table.button class="inline-flex items-center px-4 py-1.5 text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 px-1.5" color="indigo" href="{{ route('fungsionals.create') }}">
