<div class="mt-4">
    ...
    <div class="grid grid-cols-3 pb-3">
        ...
        <div class="text-right col-span-2 flex space-x-1 justify-end">
            <x-table.button color="indigo" href="{{ route('frontend.pegawaiMutasis.create') }}" class="px-3">
                        ...
                        <x-table.tr>
                            ...
                            <x-table.td class="px-6 py-4 text-right text-sm font-medium">
                                <div class="flex space-x-1 justify-end">
                                        ...
                                        <x-table.button href="{{ route('frontend.pegawaiMutasis.edit',['mutasi' => $pegawaiMutasi]) }}">
                                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
