<div class="mt-4">
    ...
    <div class="grid grid-cols-3 pb-3">
        ...
        <div class="text-right col-span-2">
            <x-form.button px="2" py="1" color="indigo" href="{{ route('frontend.pegawaiMutasis.create') }}">
                ...
                @foreach ($pegawaiMutasis as $pegawaiMutasi)
                    <x-table.tr>
                        ...
                        <x-table.td>
                            ...
                            <x-form.button class="normal-case" px="3" py="1" color="indigo" href="{{ route('frontend.pegawaiMutasis.edit',$pegawaiMutasi) }}">
                                <svg class="h-3 w-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
