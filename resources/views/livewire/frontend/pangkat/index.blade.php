<div class="mt-4">
    ...
    <div class="grid grid-cols-3 pb-3">
        ...
        <div class="text-right col-span-2 flex space-x-1 justify-end">
            <x-table.button color="indigo" href="{{ route('frontend.pegawaiPangkats.create') }}" class="px-3">
                    ...
                    <x-table.tr>
                        ...
                        <x-table.td> 
                            <div class="flex space-x-1 justify-end">
                                    ...
                                    <x-table.button class="normal-case" color="indigo" href="{{ route('frontend.pegawaiPangkats.edit',['pegawaiPangkat' => $pegawaiPangkat]) }}">
                                        <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
