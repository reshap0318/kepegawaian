<div class="mt-4">
    ...
    <div class="grid grid-cols-3 pb-3">
        ...
        <div class="text-right col-span-2">
            <x-form.button px="2" py="1" color="indigo" href="{{ route('frontend.pegawaiFungsionals.create') }}">
                ...
                @foreach ($pegawaiFungsionals as $pegawaiFungsional)
                    <x-table.tr>
                        ...
                        <x-table.td>
                            ...
                            <x-form.button class="normal-case" px="3" py="1" color="indigo" href="{{ route('frontend.pegawaiFungsionals.edit',$pegawaiFungsional) }}">
                                <svg class="h-3 w-3" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
