<x-card>
    <div class="divide-y divide-gray-200 lg:col-span-9" x-data="{ open: @entangle('isPegawai') }" >
            ...
            <div class="flex flex-col lg:flex-row">
                <div class="flex-grow space-y-6">
                    ...
                    <div class="grid grid-cols-8 gap-6">
                        <div class="col-span-8 sm:col-span-8" x-show="open">
                            <x-form.label for="nip" value="NIP" />
                            <x-form.input wire:model.lazy="nip" id="nip" disabled="true" class="block mt-1 w-full bg-gray-100" type="text" autocomplete="off"/>
