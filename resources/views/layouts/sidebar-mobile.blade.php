<div class="md:hidden">
    <div class="fixed inset-0 flex z-40" x-show="openMenu">
        ...
        <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-gray-800" @click.away="openMenu = false" @close.stop="openMenu = false"
        ...
        x-transition:leave-end="-translate-x-full">
            <div class="absolute top-0 right-0 -mr-12 pt-2">
                <button class="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" @click="openMenu = false" >
            ...
            <div class="flex-shrink-0 flex items-center px-4">
                <img class="h-8 w-auto" src="{{ asset('image/logo-unand.png') }}" alt="Workflow">
            </div>
