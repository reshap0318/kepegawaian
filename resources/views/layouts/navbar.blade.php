<div class="relative z-10 flex-shrink-0 flex h-16 bg-white shadow">
    ...
    <div class="flex-1 px-4 flex justify-between">
      ...
      <div class="ml-4 flex items-center md:ml-6">
        @livewire(App\Http\Livewire\Frontend\Notification::class)
        ...
        <div class="ml-3 relative" @click.away="openUser = false" @close.stop="openUser = false">
          ...
          <div class="origin-top-right absolute right-0 mt-3 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none border" role="menu" aria-orientation="vertical" aria-labelledby="user-menu" x-show="openUser"
