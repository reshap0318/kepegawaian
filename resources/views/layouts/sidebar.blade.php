        ...
        <div class="flex flex-col h-0 flex-1">
            ...
            <div class="flex-1 flex flex-col overflow-y-auto">
                <nav class="flex-1 px-2 py-4 bg-gray-800 space-y-1">
                    ...
                    <x-menu.dropdown :active="request()->routeIs('units.index') || request()->routeIs('fungsionals.index')"  x-show="{{ Auth::user()->hasAnyPermission(['units_access', 'fungsionals_access','pangkat-golongans_access','jabatan-units_access']) ? 'true' : 'false' }}">
                        <x-slot name="trigger"> 
                    ...
                    <x-menu.dropdown :active="request()->routeIs('roles.index') || request()->routeIs('permissions.index')" x-show="{{ Auth::user()->hasAnyPermission(['roles_access', 'permissions_access']) ? 'true' : 'false' }}">
                        <x-slot name="trigger"> 
                            <svg class="text-gray-400 group-hover:text-gray-300 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    ...
                    <x-menu.nav-link :href="route('pegawai.index')" :active="request()->routeIs('pegawai.index')">
                        <svg class="text-gray-300 mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
